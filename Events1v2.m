...
initprint = 0;
if ~(exist('~/Desktop/Data/EVENTS/EVENTS1v2/EVENTS1v2data.csv', 'file') == 2)
    initprint = 1;
end
dataFile = fopen('~/Desktop/Data/EVENTS/EVENTS1v2/EVENTS1v2data.csv', 'a');
subjFile = fopen(['~/Desktop/Data/EVENTS/EVENTS1v2/' subj '.csv'],'a');
if initprint
